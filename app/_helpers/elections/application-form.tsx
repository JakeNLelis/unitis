...
import type { ApplicationFormProps, CourseOption } from "@/lib/types/public";
import type {
  CandidacyFormData,
  CouncilType,
  CandidacyType,
...
const PDFPreview = dynamic(
  () => import("@/app/(public)/elections/[id]/apply/pdf-preview"),
  {
    ssr: false,
    loading: () => (
      ...
      <Card>
        <CardContent className="pt-6 text-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Please download and print the PDF form, sign it with a blue pen, and
            submit the hard copy to the USEB Officers.
          </p>
...
export function ApplicationFormLayout({
  ...
  onPartylistChange: (value: string) => void;
  ...
  const councilTypes: CouncilType[] = ["USSC", "FSSC"];
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="space-y-6 order-2 lg:order-1">
        <form onSubmit={onSubmit} className="space-y-6">
              ...
              {councilTypes.map((type) => (
                ...
                >
                  <input
                    ...
                    onChange={(e) => onUpdate("councilType", e.target.value)}
          ...
          <SectionCard title="Partylist Affiliation">
            <div className="space-y-4">
              <Select value={partylistId} onValueChange={onPartylistChange}>
                <SelectTrigger>
              ...
              {formData.candidacyType === "Political Party" && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onUpdate("campaignManager", e.target.value)
                    }
